...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_popular_destinations_populate_by" AS ENUM('all', 'selection');
  CREATE TYPE "public"."enum_pages_hero_type" AS ENUM('none', 'visa', 'homeHero');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_popular_destinations_populate_by" AS ENUM('all', 'selection');
  CREATE TYPE "public"."enum__pages_v_version_hero_type" AS ENUM('none', 'visa', 'homeHero');
  ...
  CREATE TYPE "public"."enum_reviews_platform" AS ENUM('instagram', '2gis');
  ...
  CREATE TABLE IF NOT EXISTS "pages_blocks_why_us" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"intro_content" jsonb,
  	"apart_rich_text" jsonb,
  	"apart_cover_id" integer,
  	"apart_hero_id" integer,
  	"apart_enable_link" boolean,
  	"apart_link_type" "enum_pages_blocks_why_us_apart_link_type" DEFAULT 'reference',
  	"apart_link_new_tab" boolean,
  	"apart_link_url" varchar,
  	"apart_link_label" varchar,
  	"apart_link_appearance" "enum_pages_blocks_why_us_apart_link_appearance" DEFAULT 'default',
  	"together_rich_text" jsonb,
  	"together_cover_id" integer,
  	"together_hero_id" integer,
  	"together_enable_link" boolean,
  	"together_link_type" "enum_pages_blocks_why_us_together_link_type" DEFAULT 'reference',
  	"together_link_new_tab" boolean,
  	"together_link_url" varchar,
  	"together_link_label" varchar,
  	"together_link_appearance" "enum_pages_blocks_why_us_together_link_appearance" DEFAULT 'default',
  	"block_name" varchar
  );
  
  CREATE TABLE IF NOT EXISTS "pages_blocks_popular_destinations" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"intro_content" jsonb,
  	"populate_by" "enum_pages_blocks_popular_destinations_populate_by" DEFAULT 'all',
  	"block_name" varchar
  );
  
  CREATE TABLE IF NOT EXISTS "pages_blocks_reviews" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_why_us" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	...
  	"apart_hero_id" integer,
  	"apart_enable_link" boolean,
  	"apart_link_type" "enum__pages_v_blocks_why_us_apart_link_type" DEFAULT 'reference',
  	"apart_link_new_tab" boolean,
  	"apart_link_url" varchar,
  	"apart_link_label" varchar,
  	"apart_link_appearance" "enum__pages_v_blocks_why_us_apart_link_appearance" DEFAULT 'default',
  	"together_rich_text" jsonb,
  	"together_cover_id" integer,
  	"together_hero_id" integer,
  	"together_enable_link" boolean,
  	"together_link_type" "enum__pages_v_blocks_why_us_together_link_type" DEFAULT 'reference',
  	"together_link_new_tab" boolean,
  	"together_link_url" varchar,
  	"together_link_label" varchar,
  	"together_link_appearance" "enum__pages_v_blocks_why_us_together_link_appearance" DEFAULT 'default',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_popular_destinations" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"intro_content" jsonb,
  	"populate_by" "enum__pages_v_blocks_popular_destinations_populate_by" DEFAULT 'all',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  
  CREATE TABLE IF NOT EXISTS "_pages_v_blocks_reviews" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "categories" (
  	...
  	"consular_fee" numeric NOT NULL,
  	"service_fee" numeric NOT NULL,
  	"visa_fee" numeric NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "reviews" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"platform" "enum_reviews_platform" NOT NULL,
  	"visa_id" integer NOT NULL,
  	"video_id" integer,
  	"text" varchar,
  	"review_href" varchar DEFAULT 'https://2gis.kz/almaty/firm/70000001069038260/tab/reviews',
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  DO $$ BEGIN
   ALTER TABLE "pages_blocks_popular_destinations" ADD CONSTRAINT "pages_blocks_popular_destinations_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."pages"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_pages_v_blocks_popular_destinations" ADD CONSTRAINT "_pages_v_blocks_popular_destinations_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "visas" ADD CONSTRAINT "visas_cover_id_media_id_fk" FOREIGN KEY ("cover_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_visas_v" ADD CONSTRAINT "_visas_v_version_cover_id_media_id_fk" FOREIGN KEY ("version_cover_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "reviews" ADD CONSTRAINT "reviews_visa_id_visas_id_fk" FOREIGN KEY ("visa_id") REFERENCES "public"."visas"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  
  DO $$ BEGIN
   ALTER TABLE "reviews" ADD CONSTRAINT "reviews_video_id_videos_id_fk" FOREIGN KEY ("video_id") REFERENCES "public"."videos"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "redirects_rels" ADD CONSTRAINT "redirects_rels_visas_fk" FOREIGN KEY ("visas_id") REFERENCES "public"."visas"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "search_rels" ADD CONSTRAINT "search_rels_visas_fk" FOREIGN KEY ("visas_id") REFERENCES "public"."visas"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_why_us_order_idx" ON "pages_blocks_why_us" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_why_us_parent_id_idx" ON "pages_blocks_why_us" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_why_us_path_idx" ON "pages_blocks_why_us" USING btree ("_path");
  ...
  CREATE INDEX IF NOT EXISTS "pages_blocks_popular_destinations_order_idx" ON "pages_blocks_popular_destinations" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_popular_destinations_parent_id_idx" ON "pages_blocks_popular_destinations" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_popular_destinations_path_idx" ON "pages_blocks_popular_destinations" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "pages_blocks_reviews_order_idx" ON "pages_blocks_reviews" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "pages_blocks_reviews_parent_id_idx" ON "pages_blocks_reviews" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "pages_blocks_reviews_path_idx" ON "pages_blocks_reviews" USING btree ("_path");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_why_us_order_idx" ON "_pages_v_blocks_why_us" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_why_us_parent_id_idx" ON "_pages_v_blocks_why_us" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_why_us_path_idx" ON "_pages_v_blocks_why_us" USING btree ("_path");
  ...
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_popular_destinations_order_idx" ON "_pages_v_blocks_popular_destinations" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_popular_destinations_parent_id_idx" ON "_pages_v_blocks_popular_destinations" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_popular_destinations_path_idx" ON "_pages_v_blocks_popular_destinations" USING btree ("_path");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_reviews_order_idx" ON "_pages_v_blocks_reviews" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_reviews_parent_id_idx" ON "_pages_v_blocks_reviews" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "_pages_v_blocks_reviews_path_idx" ON "_pages_v_blocks_reviews" USING btree ("_path");
  ...
  CREATE INDEX IF NOT EXISTS "visas_cover_idx" ON "visas" USING btree ("cover_id");
  ...
  CREATE INDEX IF NOT EXISTS "_visas_v_version_version_cover_idx" ON "_visas_v" USING btree ("version_cover_id");
  ...
  CREATE INDEX IF NOT EXISTS "reviews_visa_idx" ON "reviews" USING btree ("visa_id");
  CREATE INDEX IF NOT EXISTS "reviews_video_idx" ON "reviews" USING btree ("video_id");
  ...
  CREATE INDEX IF NOT EXISTS "redirects_rels_visas_id_idx" ON "redirects_rels" USING btree ("visas_id");
  ...
  CREATE INDEX IF NOT EXISTS "search_rels_visas_id_idx" ON "search_rels" USING btree ("visas_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "pages_blocks_popular_destinations" CASCADE;
  ...
  DROP TABLE "_pages_v_blocks_popular_destinations" CASCADE;
  ...
  DROP TYPE "public"."enum_pages_blocks_popular_destinations_populate_by";
  ...
  DROP TYPE "public"."enum__pages_v_blocks_popular_destinations_populate_by";
