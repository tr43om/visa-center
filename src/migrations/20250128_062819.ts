...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_hero_type" AS ENUM('none', 'lowImpact', 'mainHero', 'visa', 'homeHero');
  ...
  CREATE TYPE "public"."enum__pages_v_version_hero_type" AS ENUM('none', 'lowImpact', 'mainHero', 'visa', 'homeHero');
  ...
  CREATE TABLE IF NOT EXISTS "pages" (
  	...
  	"title" varchar,
  	"hero_type" "enum_pages_hero_type" DEFAULT 'mainHero',
  ...
  CREATE TABLE IF NOT EXISTS "_pages_v" (
  	...
  	"version_hero_type" "enum__pages_v_version_hero_type" DEFAULT 'mainHero',
